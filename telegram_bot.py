...
def telegram_main():
        ...
        if reply:
            if len(reply.split("/")) == 2:
                ...
                if len(n_time1) == 2 and len(n_time2) == 2:
                    ...
                    bot.send_message(tg_id, "Если у вас есть специальные предпочтения во время проживания, то вы можете их написать.")
                    userStep[tg_id] = 3
            else:
    ...
    def question_three(message):
        if message.text:
            ...
            bot.send_message(tg_id, "Если у вас остались какие-то вопросы, то ва всегда можете их задать, воспользовавшись /question")
        else:
